...
func TestHeader(t *testing.T) {
	Call(expectHeader(t, "Allow-Origin", "*")).Header("Allow-Origin", "*").Assert().Test(new(testing.T))
	Call(expectHeader(t, "Allow-Origin", "")).Header("Content-Type", "text/plain").Assert().Test(new(testing.T))
}

func TestContentType(t *testing.T) {
	Call(expectHeader(t, "Content-Type", "text/plain")).ContentType("text/plain").Assert().Test(new(testing.T))
}
